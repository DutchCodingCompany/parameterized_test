...
main() {
  parameterizedTest('list list dynamic wrong type cast', [
    ['kiwi', 14],
    ['apple', 15],
    ['banana', 16],
  ...
  parameterizedTest('list list dynamic list to long for selected test', [
    ['kiwi', 4, 1],
    ['apple', 5, 1],
  ...
  parameterizedTest('list list dynamic test', [
    ['kiwi', 4],
    ['apple', 5],
    ['banana', 6],
  ], p2((String word, int length) {
  ...
  parameterizedTest('wrap single values', [
    1,
    2,
